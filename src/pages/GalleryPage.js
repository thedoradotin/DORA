    ...
    <div>
      ...
      <List>
        ...
        <Link to="/gallery" className="nav_link">
          <ListItem button key="Gallery" className="active_link">
            <ListItemIcon>
  ...
  return (
    <Box sx={{ display: "flex" }}>
      ...
      <Box component="main" sx={{ flexGrow: 1, p: 3 }}>
        <Toolbar />
        <iframe
          src="https://docs.google.com/forms/d/e/1FAIpQLSedor6aqo5_PpYPgXogxHW3YLrwzwyer40wi3IXmM45XJ1pFw/viewform?embedded=true"
          width="640"
          height="1082"
          frameborder="0"
          marginheight="0"
