...
import "./SocialAwarenessPage.css";

const drawerWidth = 240;

function SocialAwarenessPage(props) {
  const { window } = props;
    ...
    <Box sx={{ display: "flex" }}>
      ...
      <Box component="main" sx={{ flexGrow: 1, p: 3 }}>
        ...
        <div className="education_container">
          <Carousel interval={1000}>
            <Carousel.Item>
              <img
                ...
                src="/assets/images/social-awareness/tree-plantation2.jpg"
                alt="First slide"
              />
            </Carousel.Item>
            <Carousel.Item>
              <img
                className="carousel_item"
                src="/assets/images/social-awareness/tree-plantation.jpg"
                alt="First slide"
              />
            </Carousel.Item>
            <Carousel.Item>
              <img
                className="carousel_item"
                src="/assets/images/social-awareness/women-empowerment.jpg"
                alt="First slide"
              />
          ...
          <p className="education_intro_text"></p>
          ...
          <div className="subcategory">
            ...
            <img
              src="/assets/images/education/personality-development.jpg"
              alt="primary educ"
            />
          </div> */}
        </div>
