      ...
      <Box component="main" sx={{ flexGrow: 1, p: 3 }}>
        ...
        <div className="education_container">
          <Carousel interval={1000}>
            <Carousel.Item>
              <img
                ...
                src="/assets/images/health/medical-camp.jpg"
                alt="First slide"
              />
            </Carousel.Item>
            <Carousel.Item>
              <img
                className="carousel_item"
                src="/assets/images/health/medical-camp2.jpg"
                alt="First slide"
              />
            </Carousel.Item>
            <Carousel.Item>
              <img
                className="carousel_item"
                src="/assets/images/health/yoga-camp.jpg"
                alt="First slide"
              />
            </Carousel.Item>
          </Carousel>
          ...
          <p className="education_intro_text">
            We are working with a goal of providing different health facilities
            and making people aware and careful towards their own health.
          </p>
          <div className="subcategory">
            <h3>Medical Counselling/Advice</h3>
            <p>
              We provide easy and free access to medical counselling/advice by
          ...
          <div className="subcategory">
            <h3>Yoga Camp</h3>
            <p>
              We organize yoga camps on several basis to help people in
              maintaining a healthy body.
            </p>
            <img src="/assets/images/health/yoga-camp.jpg" alt="primary educ" />
          </div>
        </div>
      </Box>
    </Box>
